...
**Lab 3**: Exibir detalhes de um exame em formato HTML a partir do token do resultado
...
**Lab 4**: Importar resultados de exames em formato CSV de forma assíncrona
